                        ...
                        <div class="max-w-4xl mx-auto mb-10">
                            ...
                            <div class="space-y-3">
                                @foreach ($incomingRequests as $req)
                                    <div
                                        class="flex items-center justify-between p-4 rounded-xl border border-slate-300/60 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/40">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-10 h-10 rounded-lg bg-emerald-600 text-white flex items-center justify-center font-bold">
                                                {{ strtoupper(substr($req->requester->name, 0, 1)) }}
                                            </div>
                                            <div>
                                                <div class="text-slate-800 dark:text-slate-100 font-semibold">
                                                    {{ $req->requester->name }}</div>
                                                <div class="text-slate-500 dark:text-slate-400 text-sm">wants to be
                                                    your friend</div>
                                            </div>
                                        </div>
