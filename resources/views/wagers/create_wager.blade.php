<div class="fixed inset-0 z-50 select-none">
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            <div
                class="relative transform overflow-hidden rounded-xl bg-slate-50 dark:bg-slate-900 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-2xl
                ring-1 ring-slate-300 dark:ring-slate-700 backdrop-blur-sm">

                <div class="bg-slate-50 dark:bg-slate-900 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span
                                                :class="{ 'font-medium text-emerald-600 dark:text-emerald-400': !
                                                    isPrivate, 'text-slate-400': isPrivate }"
                                        ...
                                        <button @click.prevent="isPrivate = !isPrivate"
                                            ...
                                            :class="{ 'bg-emerald-200 dark:bg-emerald-800': !
                                                isPrivate, 'bg-rose-200 dark:bg-rose-800': isPrivate }">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <svg :class="{ 'text-rose-600 dark:text-rose-400': isPrivate, 'text-slate-400': !
                                                    isPrivate }"
                                                class="w-5 h-5 transition-colors" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <span
                                                :class="{ 'font-medium text-rose-600 dark:text-rose-400': isPrivate, 'text-slate-400':
                                                        !isPrivate }"
                                                class="text-sm transition-colors duration-200">
                                                Private
                                            </span>
                            ...
                            <div>
                                ...
                                <div class="space-y-3 max-h-48 overflow-y-auto">
                                    @foreach ($friends as $friend)
                                        <div class="p-4 border rounded-lg hover:shadow-sm transition-all duration-300 bg-slate-100 dark:bg-slate-800 border-slate-300 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700"
                                            data-friend-id="{{ $friend->id }}">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-3">
                                                    <div
                                                        class="w-12 h-12 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-full flex items-center justify-center shadow-md">
                                ...
                                <template x-for="(choice, index) in choices" :key="index">
                                    <div class="flex items-center gap-2 mb-2">
                                        ...
                                        <button type="button" @click="choices.splice(index, 1)"
                                            ...
                                            class="px-3 py-2 text-rose-600 dark:text-rose-400 border border-rose-300 dark:border-rose-700 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-colors">Remove</button>
                                    </div>
                                </template>
