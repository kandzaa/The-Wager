        ...
        <section>
            <div class="flex items-center gap-3 mb-6">
                ...
                @if($wagers->isNotEmpty())
                    <span class="ml-auto px-2.5 py-0.5 bg-emerald-50 dark:bg-emerald-900/40 border border-emerald-200 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-xs font-semibold rounded-full">{{ $wagers->total() }}</span>
                @endif
            </div>
