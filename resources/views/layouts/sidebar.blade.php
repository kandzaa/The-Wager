    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        @php
            $links = [
                ...
                ['route' => 'leaderboard', 'label' => 'Leaderboard', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'],
                ['route' => 'coinflip',    'label' => 'Coinflip',    'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
            ];
        @endphp
           ...
           class="group flex items-center gap-3 px-3 py-3 rounded-xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200/60 dark:border-white/[0.05] hover:bg-slate-100 dark:hover:bg-white/[0.07] hover:border-slate-300 dark:hover:border-white/[0.10] transition-all duration-200">
            ...
            <div class="min-w-0 flex-1">
                ...
                <div class="flex items-center gap-1 mt-0.5">
                    <img src="https://img.icons8.com/?size=100&id=59840&format=png&color=000000" alt="" class="w-3 h-3 shrink-0 dark:invert">
