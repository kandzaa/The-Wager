...
<body
    class="font-sans text-slate-900 dark:text-slate-100 antialiased bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 transition-colors duration-300">
